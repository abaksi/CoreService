...
namespace CoreserviceClientReference.HelperModels
{

/// <summary>
    /// A wrapper around the content or metadata fields of a Tridion item. 
    /// (Tridion Code Practice: (https://github.com/TridionPractice/tridion-practice)
/// </summary>
/// 
    ...
    public class ValueCollection
    {
        ...
        {
            return fields.GetFieldElements(definition).Select(elm => IsLinkField ? elm.Attributes["xlink:href"].Value : elm.InnerXml).GetEnumerator();
        }
    }
